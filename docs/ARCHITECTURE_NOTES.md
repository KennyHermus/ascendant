# Ascendant Technical Architecture — Implementation Notes

> **Note:** This file contains detailed v0.0.x implementation archaeology. For the current subsystem index, start with [ARCHITECTURE.md](ARCHITECTURE.md).

Version: historical notes through v0.0.4 (save schema 0.0.9)
